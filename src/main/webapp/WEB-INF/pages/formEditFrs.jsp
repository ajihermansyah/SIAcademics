          ...
          <div class="">
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
				  ...
				  <div class="x_content">
                    <br />
                    <form:form onsubmit="return checkForm(this);" action="${pageContext.request.contextPath}/prstudy" method="POST"  modelAttribute="prsForm" role="form" class="form-horizontal form-label-left" >
		    		  <form:hidden path="id"/>
		    		  <div class="item form-group">
                 			 <label class="control-label col-md-3 col-sm-3 col-xs-12">NIM</label>
                  			  <div class="col-md-6 col-sm-6 col-xs-12">
                  			 		<form:input path="nim" class="form-control" placeholder="Enter Subject Code" required="required"/>
              	   		...
              	   		<div class="item form-group">
                 			 <label class="control-label col-md-3 col-sm-3 col-xs-12">Date</label>
                  			  <div class="col-md-6 col-sm-6 col-xs-12">
                  			 		<form:input path="tgl_frs" class="form-control" placeholder="Enter SKS" required="required"/>
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
						...
						<c:forEach items="${mk}" var="info"
							...
							<c:set var="count" value="${count+1}" scope="page"/>
								...
								<td><input type="checkbox"  name="choose_mk" value="${info.sbjId.id}" checked></td>
							</tr>
						</c:forEach>
						
						<c:forEach items="${listUniqueSubject}" var="info"
							varStatus="status">
							<tr>
								<c:set var="count" value="${count+1}" scope="page"/>
								<td><c:out value="${count}"/></td>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          ...
                          <a href="${pageContext.request.contextPath}/frstudies" class="btn btn-warning">Cancel</a>
                        </div>
                      </div>
