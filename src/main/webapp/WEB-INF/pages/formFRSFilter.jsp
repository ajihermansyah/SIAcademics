...
<html lang="en">
  ...
  <body class="nav-md">
          ...
          <div class="">
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
				  ...
				  <div class="x_content">
                    <br />
                    <form:form action="${pageContext.request.contextPath}/frstudy/${frsId}/create" method="GET"  modelAttribute="frsFilterForm" role="form" class="form-horizontal form-label-left" >
		    		  <form:hidden path="id"/>
	...
	<script src="${pageContext.request.contextPath}/build/js/jquery-1.4.2.min.js"></script>
