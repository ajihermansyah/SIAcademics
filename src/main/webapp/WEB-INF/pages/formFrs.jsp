          ...
          <div class="">
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
				  ...
				  <div class="x_content">
                    <br />
                    <form:form onsubmit="return checkForm(this);" action="${pageContext.request.contextPath}/frstudy" method="POST"  modelAttribute="frsForm" role="form" class="form-horizontal form-label-left" >
		    		  <form:hidden path="id"/>
		    		  <div class="item form-group">
              	   		...
              	   		<div class="item form-group">
                 			 <label class="control-label col-md-3 col-sm-3 col-xs-12">Date</label>
              	   		       <div class="col-md-6 col-sm-6 col-xs-12">
                                	<form:input path="tgl_frs" type="text" class="form-control has-feedback-left" id="single_cal4" placeholder="Enter Date" required="required"/>
