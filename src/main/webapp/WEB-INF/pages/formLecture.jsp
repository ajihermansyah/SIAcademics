                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i> Form Creates <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
						...
						<li><a href="${pageContext.request.contextPath}/lecture">Lecture</a></li>
                  ...
                  <li><a><i class="fa fa-table"></i> Table Views <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="${pageContext.request.contextPath}/subjects">Subjects</a></li>
                       <li><a href="${pageContext.request.contextPath}/lectures">Lectures</a></li>
          ...
          <div class="">
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
				  ...
				  <div class="x_content">
                    <br />
                    <form:form action="${pageContext.request.contextPath}/lecture" method="POST"  modelAttribute="lectureForm" role="form" class="form-horizontal form-label-left" >
		    		  <form:hidden path="id"/>
		    		  <div class="item form-group">
<!--                  			 <label class="control-label col-md-3 col-sm-3 col-xs-12">NIM</label> -->
                  			  <div class="col-md-6 col-sm-6 col-xs-12">
                  			 		<form:hidden path="NID" class="form-control" placeholder="Enter NID"/>
					  	     		<form:errors path="NID" class="error-message" />
              	   		      </div>
              	   		</div>
              	   		<div class="item form-group">
                 			 <label class="control-label col-md-3 col-sm-3 col-xs-12">Name</label>
                  			  <div class="col-md-6 col-sm-6 col-xs-12">
                  			 		<form:input path="lectureName" class="form-control" placeholder="Enter Lecture Name" required="required"/>
					  	     		<form:errors path="lectureName" class="error-message" />
              	   		      </div>
              	   		</div>
