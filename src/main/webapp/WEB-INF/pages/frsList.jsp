                          ...
                          <tr class="even pointer">
                        	 <c:forEach items="${frsInfos}" var="info" varStatus="status">
								<tr>
								     ...
								     <td>${info[6]}</td>
								     <td>
								    	<a data-toggle="tooltip" data-placement="top" title="Delete"  onclick="return confirm('Are you sure you want to delete?')" href="frstudy/${info[7]}">
                							<span class="fa fa-trash-o" aria-hidden="true"></span>
               							</a>
               					    </td>
									 <td><a href="frstudy/${info[7]}/edit">PRS</a></td>
									 <td><a href="${pageContext.request.contextPath}/frstudies/${info[7]}/details">FRS Details</a></td>
							    </tr>
							</c:forEach>
                          </tr>
                        </tbody>
