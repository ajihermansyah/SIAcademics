...
<html lang="en">
  <head>
    ...
    <title>SIAcademics | List Major </title>
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title">Head Of Major </th>
                        ...
                        <tbody>
                          <tr class="even pointer">
                        	 <c:forEach items="${majorInfos}" var="info" varStatus="status">
								<tr>
									<td>${status.index + 1}</td>
									<td>${info.majorCode}</td>
									<td>${info.majorName}</td>
									<td>${info.faculty}</td>
									<td>${info.headMajor}</td>
									<td>
										<a data-toggle="tooltip" data-placement="top" title="Delete"  onclick="return confirm('Are you sure you want to delete?')" href="major/${info.id}">
                							<span class="fa fa-trash-o" aria-hidden="true"></span>
               							</a>
               					    </td>
               					    <td><a data-toggle="tooltip" data-placement="top" title="Edit" href="major/${info.id}/edit">
