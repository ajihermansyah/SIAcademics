          ...
          <div class="">
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
				  ...
				  <div class="x_content">
				  <br />
                   <form:form action="${pageContext.request.contextPath}/reportMaxSks" method="GET">
						<div class="item form-group">
                 			 <label class="control-label col-md-3 col-sm-3 col-xs-12">Subjects</label>
                  			  <div class="col-md-6 col-sm-6 col-xs-12">
                  			
                  			 		<select class="form-control" name="choose">
										<option value="Ganjil" label="Ganjil"/>
										<option value="Genap" label="Genap"/>	
									<select>
              	   		      </div>
              	   		</div>
                 <br/><br/><br/>
                      ...
                      <table class="table table-striped jambo_table bulk_action" >
                        ...
                        <tbody>
                          <tr class="even pointer">
                        	 <c:forEach items="${reportMaxSks}" var="info" varStatus="status">
								<tr>
