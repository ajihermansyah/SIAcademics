...
<html lang="en">
  <head>
    ...
    <title>SIAcademics | Favorite Subject Reports </title>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Favorite Subject Reports</h3>
              </div>
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        ...
                        <tbody>
                          <tr class="even pointer">
                        	 <c:forEach items="${reportTop3MaxSubjects}" var="info" varStatus="status">
								<tr>
									<td>${status.index + 1}</td>
									<td>${info[0].subjectName}</td>
									<td>${info[1]}</td>
								</tr>
							</c:forEach>
                          </tr>
