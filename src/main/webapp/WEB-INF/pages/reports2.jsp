...
<html lang="en">
  <head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/build/js/jquery-1.4.2.min.js"></script>
          ...
          <div class="">
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
				  ...
				  <div class="x_content">
				  <br />
                   <form:form action="${pageContext.request.contextPath}/reports2" method="GET">
                      ...
                      <table class="table table-striped jambo_table bulk_action" >
                        ...
                        <tbody>
                          <tr class="even pointer">
                        	 <c:forEach items="${reports2}" var="info" varStatus="status">
								<tr>
