...
<html lang="en">
  <head>
    ...
    <title>SIAcademics | Room List</title>
  ...
  <body class="nav-md">
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title">Room Code </th>
                        ...
                        <tbody>
                          <tr class="even pointer">
                        	 <c:forEach items="${roomInfos}" var="info" varStatus="status">
								<tr>
					   				 <td>${status.index + 1}</td>
									 <td>${info.roomCode}</td>
									 <td>${info.roomName}</td>
									 <td>
									 	 <a data-toggle="tooltip" data-placement="top" title="Delete"  onclick="return confirm('Are you sure you want to delete?')" href="room/${info.id}">
                							<span class="fa fa-trash-o" aria-hidden="true"></span>
               							 </a>
               					    </td>
               					    <td><a data-toggle="tooltip" data-placement="top" title="Edit" href="room/${info.id}/edit">
    ...
    <script src="${pageContext.request.contextPath}/build/js/ajax.min.js"></script> 
