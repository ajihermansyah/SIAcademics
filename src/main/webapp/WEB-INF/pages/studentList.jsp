							...
							<ul class="nav side-menu">
								...
								<li><a><i class="fa fa-bar-chart-o"></i> Reports <span
									...
									<ul class="nav child_menu">
										...
										<li><a
											href="${pageContext.request.contextPath}/reports2/0">Student
										</a></li>
									</ul></li>
							</ul>
						</div>
						...
						<div class="title_right">
							<div
								...
								<div class="input-group">
									<input type="text" class="form-control" id="tfSearch" onkeyup="myFunction()"
										...
										<table id="tableData" class="table table-striped jambo_table bulk_action">
											<thead>
												<tr class="headings">
													...
													<th class="column-title no-link last" colspan="3"><span
											...
											<tbody>
												<tr class="even pointer">
													<c:forEach items="${studentInfos}" var="info"
														varStatus="status">
														<tr>
															...
															<td><a data-toggle="tooltip" data-placement="top"
																...
																href="student/${info.id}"> <span
																	class="fa fa-trash-o" aria-hidden="true"></span>
															</a></td>
															<td><a data-toggle="tooltip" data-placement="top"
																title="Edit" href="student/${info.id}/edit"> <span
																	class="fa fa-edit" aria-hidden="true"></span>
															</a></td>
															<td><a
																href="${pageContext.request.contextPath}/frstudy/${info.id}/filter">FRS</a></td>
														</tr>
													</c:forEach>
												</tr>
											</tbody>
