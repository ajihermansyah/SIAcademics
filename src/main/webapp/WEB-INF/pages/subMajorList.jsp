...
<html lang="en">
  <head>
    ...
    <title>SIAcademics | SubMajor List</title>
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title">Majors </th>
                        ...
                        <tbody>
                          <tr class="even pointer">
                        	 <c:forEach items="${subMajorInfos}" var="info" varStatus="status">
								<tr>
					   				   <td>${status.index + 1}</td>
									   <td>${info.majorId.majorName}</td>
									   <td>${info.subjectId.subjectName}</td>
									   <td>${info.subjectId.semester}</td>
									 	<td>
									 		<a data-toggle="tooltip" data-placement="top" title="Delete"  onclick="return confirm('Are you sure you want to delete?')" href="subMajor/${info.id}">
                								<span class="fa fa-trash-o" aria-hidden="true"></span>
               								</a>
               					   		</td>
               					    	<td><a data-toggle="tooltip" data-placement="top" title="Edit" href="subMajor/${info.id}/edit">
