...
<html lang="en">
  <head>
    ...
    <title>SIAcademics | Subject List</title>
                      ...
                      <table class="table table-striped jambo_table bulk_action" id="tableData">
                        ...
                        <tbody>
                          <tr class="even pointer">
                        	 <c:forEach items="${subjectInfos}" var="info" varStatus="status">
								<tr>
										...
										<td>${info.semester}</td>
									 	<td>
               					    	...
               					    	<td><a data-toggle="tooltip" data-placement="top" title="Edit" href="subject/${info.id}/edit">
