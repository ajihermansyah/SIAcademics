        ...
        <div class="right_col" role="main">
          <div class="">
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Major Form <small>Click to validate</small></h2>
                    <div class="clearfix"></div>
                  </div>
				  <div class="x_content">
                    <br />
                    <form:form action="${pageContext.request.contextPath}/major" method="POST"  modelAttribute="majorForm" role="form" class="form-horizontal form-label-left" >
		    		  <form:hidden path="id"/>
                      <div class=" item form-group">
                         <label class="control-label col-md-3 col-sm-3 col-xs-12" >Major Code</label>
                  			<div class="col-md-6 col-sm-6 col-xs-12">
								 <form:input path="majorCode" class="form-control" placeholder="Enter Major Code (2 Digit)" required="required" maxlength="2"/>
				 		     	 <form:errors path="majorCode" class="error-message" />
               		    	</div>
               		    </div>
						<div class="item form-group">
                 			 <label class="control-label col-md-3 col-sm-3 col-xs-12">Major Name</label>
                  			  <div class="col-md-6 col-sm-6 col-xs-12">
                  			 		<form:input path="majorName" class="form-control" placeholder="Enter Major Name" required="required"/>
					  	     		<form:errors path="majorName" class="error-message" />
              	   		      </div>
              	   		</div>		
              	   		<div class="item form-group">
                 			 <label class="control-label col-md-3 col-sm-3 col-xs-12">Faculty</label>
                  			  <div class="col-md-6 col-sm-6 col-xs-12">
                  			 		<form:input path="faculty" class="form-control" placeholder="Enter Faculty" required="required"/>
					  	     		<form:errors path="faculty" class="error-message" />
              	   		      </div>
              	   		</div>
              	   		<div class="item form-group">
                 			 <label class="control-label col-md-3 col-sm-3 col-xs-12">Head Major</label>
                  			  <div class="col-md-6 col-sm-6 col-xs-12">
                  			 		<form:input path="headMajor" class="form-control" placeholder="Enter Head of Major" required="required"/>
					  	     		<form:errors path="headMajor" class="error-message" />
              	   		      </div>
              	   		</div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          ...
                          <a href="${pageContext.request.contextPath}/majors" class="btn btn-warning">Cancel</a>
                        </div>
                      </div>
