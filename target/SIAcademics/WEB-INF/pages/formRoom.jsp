        ...
        <div class="right_col" role="main">
          <div class="">
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Room Form <small>Click to validate</small></h2>
                    <div class="clearfix"></div>
                  </div>
				  <div class="x_content">
                    <br />
                    <form:form action="${pageContext.request.contextPath}/room" method="POST"  modelAttribute="roomForm" role="form" class="form-horizontal form-label-left" >
		    		  <form:hidden path="id"/>
                      <div class=" item form-group">
                         <label class="control-label col-md-3 col-sm-3 col-xs-12" >Room Code</label>
                  			<div class="col-md-6 col-sm-6 col-xs-12">
								 <form:input path="roomCode" class="form-control" placeholder="Enter Room Code" required="required"/>
				 		     	 <form:errors path="roomCode" class="error-message" />
               		    	</div>
               		    </div>
						<div class="item form-group">
                 			 <label class="control-label col-md-3 col-sm-3 col-xs-12">Room Name</label>
                  			  <div class="col-md-6 col-sm-6 col-xs-12">
                  			 		<form:input path="roomName" class="form-control" placeholder="Enter Room Name" required="required"/>
					  	     		<form:errors path="roomName" class="error-message" />
              	   		      </div>
              	   		</div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          ...
                          <a href="${pageContext.request.contextPath}/rooms" class="btn btn-warning">Cancel</a>
                        </div>
                      </div>
