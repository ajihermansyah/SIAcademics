        ...
        <div class="right_col" role="main">
          <div class="">
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Schedule Form <small>Click to validate</small></h2>
                    <div class="clearfix"></div>
                  </div>
				  <div class="x_content">
                    <br />
                    <form:form action="${pageContext.request.contextPath}/schedule" method="POST"  modelAttribute="scheduleForm" role="form" class="form-horizontal form-label-left" >
		    		  <form:hidden path="id"/>
                      <div class=" item form-group">
                  			...
                  			<div class="col-md-6 col-sm-6 col-xs-12">
								<form:select path="room" class="form-control">
									<c:forEach items="${room}" var="r">
										<c:choose>
											<c:when test="${r.id==ScheduleForm.getRoom()}">
												<option value="${r.id}" selected>${r.roomName}</option>
											</c:when>
						...
						<div class="item form-group">
                 			 <label class="control-label col-md-3 col-sm-3 col-xs-12">Subjects</label>
                  			  <div class="col-md-6 col-sm-6 col-xs-12">
                  			 		<form:select path="subj" class="form-control">
										<c:forEach items="${mk}" var="j">
											<c:choose>
												<c:when test="${j.id==scheduleForm.getSubj()}">
													<option value="${j.id}" selected>${j.subjectName}</option>
												</c:when>

												<c:otherwise>
													<option value="${j.id}">${j.subjectName}</option>
												</c:otherwise>
											</c:choose>
										</c:forEach>
									</form:select>
              	   		...
              	   		<div class="item form-group">
                 			 <label class="control-label col-md-3 col-sm-3 col-xs-12">Jam Masuk</label>
                  			  <div class="col-md-6 col-sm-6 col-xs-12">
                  			 		<form:input path="jam_masuk" class="form-control" placeholder="Enter Jam Masuk" required="required"/>
					  	     		<form:errors path="jam_masuk" class="error-message" />
              	   		      </div>
              	   		</div>
              	   		<div class="item form-group">
                 			 <label class="control-label col-md-3 col-sm-3 col-xs-12">Jam Keluar</label>
                  			  <div class="col-md-6 col-sm-6 col-xs-12">
                  			 		<form:input path="jam_keluar" class="form-control" placeholder="Enter Jam Keluar" required="required"/>
              	   		...
              	   		<div class="item form-group">
                 			 <label class="control-label col-md-3 col-sm-3 col-xs-12">Date</label>
                  			  <div class="col-md-6 col-sm-6 col-xs-12">
                  			 		<form:input path="date" class="form-control" placeholder="Enter Date" required="required"/>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          ...
                          <a href="${pageContext.request.contextPath}/schedules" class="btn btn-warning">Cancel</a>
                        </div>
                      </div>
