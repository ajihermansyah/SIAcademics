        ...
        <div class="right_col" role="main">
          <div class="">
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Sub-Major Form <small>Click to validate</small></h2>
                    <div class="clearfix"></div>
                  </div>
				  <div class="x_content">
                    <br />
                    <form:form action="${pageContext.request.contextPath}/subMajor" method="POST"  modelAttribute="subMajorForm" role="form" class="form-horizontal form-label-left" >
		    		  <form:hidden path="id"/>
                  			  ...
                  			  <div class="col-md-6 col-sm-6 col-xs-12">
                  			 		<form:select path="majorId" class="form-control">
										<c:forEach items="${major}" var="j">
											<c:choose>
												<c:when test="${j.id==subMajorForm.getMajorId()}">
                  			  ...
                  			  <div class="col-md-6 col-sm-6 col-xs-12">
                  			 		<form:select path="subjectId" class="form-control">
										<c:forEach items="${mk}" var="j">
											<c:choose>
												<c:when test="${j.id==subMajorForm.getSubjectId()}">
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          ...
                          <a href="${pageContext.request.contextPath}/subMajors" class="btn btn-warning">Cancel</a>
                        </div>
                      </div>
