        ...
        <div class="right_col" role="main">
          <div class="">
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Subject Form <small>Click to validate</small></h2>
                    <div class="clearfix"></div>
                  </div>
				  <div class="x_content">
                    <br />
                    <form:form action="${pageContext.request.contextPath}/subject" method="POST"  modelAttribute="subjectForm" role="form" class="form-horizontal form-label-left" >
		    		  <form:hidden path="id"/>
		    		  <div class="item form-group">
                 			 <label class="control-label col-md-3 col-sm-3 col-xs-12">Subject Code</label>
                  			  <div class="col-md-6 col-sm-6 col-xs-12">
                  			 		<form:input path="subjectCode" class="form-control" placeholder="Enter Subject Code" required="required"/>
					  	     		<form:errors path="subjectCode" class="error-message" />
              	   		      </div>
              	   		</div>
              	   		<div class="item form-group">
                 			 <label class="control-label col-md-3 col-sm-3 col-xs-12">Subject Name</label>
                  			  <div class="col-md-6 col-sm-6 col-xs-12">
                  			 		<form:input path="subjectName" class="form-control" placeholder="Enter Subject Name" required="required"/>
					  	     		<form:errors path="subjectName" class="error-message" />
              	   		      </div>
              	   		</div>
              	   		<div class="item form-group">
                 			 <label class="control-label col-md-3 col-sm-3 col-xs-12">SKS</label>
                  			  <div class="col-md-6 col-sm-6 col-xs-12">
                  			 		<form:input path="sks" class="form-control" placeholder="Enter SKS" required="required"/>
					  	     		<form:errors path="sks" class="error-message" />
              	   		      </div>
              	   		</div>
                      <div class=" item form-group">
                         <label class="control-label col-md-3 col-sm-3 col-xs-12" >Semester</label>
                  			<div class="col-md-6 col-sm-6 col-xs-12">
								<form:select path="semester" class="form-control">
									<form:option value="" label="- Semester -" /> 
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          ...
                          <a href="${pageContext.request.contextPath}/subjects" class="btn btn-warning">Cancel</a>
                        </div>
                      </div>
