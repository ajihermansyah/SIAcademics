...
<html lang="en">
  <head>
    ...
    <title>SIAcademics | FRS List</title>
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title">FRS Date </th>
                            <th class="column-title">Lecture </th>
                            <th class="column-title">Total SKS </th>
                        ...
                        <tbody>
                          <tr class="even pointer">
                        	 <c:forEach items="${frsInfos}" var="info" varStatus="status">
								<tr>
								     ...
								     <td>${info[6]}</td>
								     <td>
								    	<a data-toggle="tooltip" data-placement="top" title="Delete"  onclick="return confirm('Are you sure you want to delete?')" href="deleteFrs?id=${info[7]}">
                							<span class="fa fa-trash-o" aria-hidden="true"></span>
               							</a>
               					    </td>
									 <td><a href="editFrs?id=${info[7]}">PRS</a></td>
									 <td><a href="${pageContext.request.contextPath}/frstudiesDetails?id=${info[7]}">FRS Details</a></td>
							    </tr>
							</c:forEach>
                          </tr>
                        </tbody>
