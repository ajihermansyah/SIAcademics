...
<html lang="en">
  <head>
    ...
    <title>SIAcademics | Major With most Subject Reports </title>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Major with Most Subject Reports</h3>
              </div>
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title">Counter </th>
                        ...
                        <tbody>
                          <tr class="even pointer">
                        	 <c:forEach items="${reportMaxSubject}" var="info" varStatus="status">
								<tr>
									<td>${status.index + 1}</td>
									<td>${info[0].majorName}</td>
									<td>${info[1]}</td>
								</tr>
							</c:forEach>
                          </tr>
