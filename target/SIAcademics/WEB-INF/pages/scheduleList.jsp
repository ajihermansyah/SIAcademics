...
<html lang="en">
  <head>
    ...
    <title>SIAcademics | Schedule List</title>
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        ...
                        <tbody>
                          <tr class="even pointer">
                        	 <c:forEach items="${scheduleInfos}" var="info" varStatus="status">
								<tr>
									<td>${status.index + 1}</td>
									<td>${info.subj.subjectCode}</td>
									<td>${info.subj.subjectName}</td>
									<td>${info.subj.sks}</td>
									<td>${info.room.roomName}</td>
									<td>${info.jam_masuk}</td>
									<td>${info.jam_keluar}</td>
									<td>${info.date}</td>
									 <td>
									 	<a data-toggle="tooltip" data-placement="top" title="Delete"  onclick="return confirm('Are you sure you want to delete?')" href="schedule/${info.id}">
                							<span class="fa fa-trash-o" aria-hidden="true"></span>
               							</a>
               					    </td>
               					    <td><a data-toggle="tooltip" data-placement="top" title="Edit" href="schedule/${info.id}/edit">
