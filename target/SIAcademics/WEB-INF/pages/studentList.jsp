...
<html lang="en">
  <head>
    ...
    <title>SIAcademics | Student List</title>
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title">Tahun Angkatan </th>
                        ...
                        <tbody>
                          <tr class="even pointer">
                        	 <c:forEach items="${studentInfos}" var="info" varStatus="status">
								<tr>
					   				 <td>${status.index + 1}</td>
									 <td>${info.nim}</td>
						 			 <td>${info.studentName}</td>
									 <td>${info.major.majorName}</td>
									 <td>${info.tahun_angkatan}</td>
									 <td>${info.status}</td>
									 <td>
										<a data-toggle="tooltip" data-placement="top" title="Delete"  onclick="return confirm('Are you sure you want to delete?')" href="student/${info.id}">
                							<span class="fa fa-trash-o" aria-hidden="true"></span>
               							</a>
               					    </td>
               					    <td><a data-toggle="tooltip" data-placement="top" title="Edit" href="student/${info.id}/edit">
                							<span class="fa fa-edit" aria-hidden="true"></span>
               							</a>
               					    </td>
									 <td><a href="${pageContext.request.contextPath}/createFrsFilter?id=${info.id}">FRS</a></td>
								</tr>
							</c:forEach>
                          </tr>
                        </tbody>
